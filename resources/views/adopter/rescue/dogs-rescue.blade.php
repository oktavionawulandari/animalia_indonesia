...
@section('title', 'Data Rescue Anjing')
    ...
    <div class="container" style="padding-top: 195px;">
        <div class="row">
            <div class="col-lg-3">
                <div class="shop__sidebar">
                    <div class="shop__sidebar__search">
                        <form action="{{ route('adopter.rescue.dogs') }}" method="GET">
                                    ...
                                    <div class="card-body">
                                        <div class="shop__sidebar__categories">
                                            <ul class="nice-scroll">
                                                <li><a href="{{ route('adopter.data.rescue') }}" class="nav-link {{ request()->is('list/rescue') ? 'active' : '' }}">Semua Data</a></li>
                                                <li><a href="{{ route('adopter.rescue.dogs') }}" class="nav-link {{ request()->is('list/rescue/dogs') ? 'active' : '' }}">Anjing</a></li>
                                                <li><a href="{{ route('adopter.rescue.cats') }}" class="nav-link {{ request()->is('list/rescue/cats') ? 'active' : '' }}">Kucing</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="col-lg-9">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        {{ $rescues->links('layout-adopter.pagination') }}
                    </div>
                </div>
            </div>
        </div>
