            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title">Data Adopsi Gagal</h4>
                        ...
                        <table id="basic-datatables" class="display table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <form action="{{ route('handle.button.action', ['id' => $adoption->id]) }}" method="POST">
                                        @csrf
                                        <input type="hidden" name="action" value="duplicateAndChangeStatus">
                                        <button type="submit" class="btn btn-warning btn-xs">Duplicate and Change Status</button>
                                    </form>
                                @endforeach
                                    </td>
                                </tr>
