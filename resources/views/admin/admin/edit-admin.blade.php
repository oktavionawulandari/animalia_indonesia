    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-sample" action="{{ route('update.admin.account', $admin->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    <label>Level</label>
                                    <input type="text" class="form-control @error('level') is-invalid @enderror" id="level" name="level" value="{{ old('level', $admin->level) }}" readonly>
                                    @error('level')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
